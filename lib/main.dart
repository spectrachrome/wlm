...
import './views/real_time_info.dart';
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          ...
          bodyLarge: TextStyle(fontSize: 14.0, fontFamily: 'Inter', color: Color(0xFFcccccc)),
          bodyMedium: TextStyle(fontSize: 14.0, fontFamily: 'Inter', color: Color(0xFFcccccc)),
        ),
        useMaterial3: true,
      ),
      darkTheme: ThemeData(
